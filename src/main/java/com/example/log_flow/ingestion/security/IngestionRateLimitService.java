...
@Service
public class IngestionRateLimitService {

    private final Map<String, Bucket> buckets = new ConcurrentHashMap<>();
    private final long requestsPerMinute;
    private final long burstCapacity;

    public IngestionRateLimitService(@Value("${ingestion-rate-limit.requests-per-minute}") long requestsPerMinute,
                                     @Value("${ingestion-rate-limit.burst-capacity}") long burstCapacity) {
